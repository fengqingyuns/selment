 ...
 * @date 2017年11月2日 下午2:39:58
 */
@JobHander(value="settleBillGenerateJobHandler")
@Component
public class SettleBillGenerateJobHandler extends IJobHandler{
    @Resource
    ...
    public ReturnT<String> execute(String... params) throws Exception {
        ...
        SettleBillGenResultVo result = settleBillGenService.genSettleBill(date, brandId);
