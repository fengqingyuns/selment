...
@Repository
public interface SettleSettingDao {

    public List<SettleSetting> selectBySettleSettingList(SettleSettingReq record);

    public int selectBySettleSettingCount(SettleSettingReq record);
